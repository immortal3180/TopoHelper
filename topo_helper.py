...
root = tk.Tk()
root.title("topo-helper")
root.geometry("900x650")

# 主分栏: 左控制 右日志
main_pw = tk.PanedWindow(root, orient="horizontal", sashwidth=4, bg="#45475a")
main_pw.pack(fill="both", expand=True)

left = tk.Frame(main_pw, bg="#1e1e2e", width=420)
